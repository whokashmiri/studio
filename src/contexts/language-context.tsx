...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    selectFolderForAssetTooltip: "Select a folder to add an asset",
    noFolderSelectedForAssetTitle: "No Folder Selected",
    ...
    selectFolderToViewAssetsDesc: "Select a folder from the tree to view its assets or add new ones.",
    noFolderSelectedPrompt: "Select a folder to view assets or create a new folder.",
  },
  ar: {
    ...
    selectFolderForAssetTooltip: "حدد مجلدًا لإضافة أصل إليه",
    noFolderSelectedForAssetTitle: "لم يتم تحديد مجلد",
    noFolderSelectedForAssetDesc: "يرجى إنشاء أو تحديد مجلد قبل إضافة أصل.",
    breadcrumbSeparator: "<", 
    clickToNavigateTo: "انقر للانتقال إلى {name}",
    selectFolderToViewAssetsDesc: "حدد مجلدًا من الشجرة لعرض أصوله أو إضافة أصول جديدة.",
    noFolderSelectedPrompt: "حدد مجلدًا لعرض الأصول أو قم بإنشاء مجلد جديد.",
  },
};
